  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        '-popup-2': '-popup-2 0.5s ease-in-out backwards',
        '-popup-1': '-popup-1 0.5s ease-in-out 0.1s backwards',
        popup: 'popup 0.5s ease-in-out 0.2s backwards',
        'popup-1': 'popup-1 0.5s ease-in-out 0.3s backwards',
        'popup-2': 'popup-2 0.5s ease-in-out 0.4s backwards',
      },
    },
  },
  plugins: [],
